...
<acme:form>
    ...
    <acme:input-email code="administrator.airline.form.label.optionalEmail" path="optionalEmail"/>
    ...
    <jstl:choose>
        ...
        <jstl:when test="${_command == 'show'}">
            <acme:submit code="administrator.airline.form.button.update" action="/administrator/airline/update?id=${id}"/>
        </jstl:when>
    </jstl:choose>
